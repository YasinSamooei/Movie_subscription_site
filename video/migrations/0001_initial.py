    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.CharField(blank=True, choices=[('فارسی', 'فارسی'), ('انگلیسی', 'انگلیسی'), ('آلمانی', 'آلمانی')], max_length=10, null=True, verbose_name='رده سنی')),
                ...
                ('favorites', models.ManyToManyField(blank=None, default=None, related_name='favorites', to=settings.AUTH_USER_MODEL, verbose_name='مورد علاقه\u200cها')),

...
class Actors(models.Model):
    ...
    slug = models.SlugField(
        "اسلاگ", allow_unicode=True, blank=True, null=True, unique=True
    )
    created_at = models.DateTimeField(
        "تاریخ آپلود دسته بندی", auto_now_add=True, null=True
    )
    updated_at = models.DateTimeField(
        "تاریخ به روز رسانی دسته بندی", auto_now=True, null=True
    )
...
class Video(models.Model):
    ...
    category = models.ManyToManyField(
        Category, related_name="videos", verbose_name="دسته بندی"
    )
    actors = models.ManyToManyField(
        Actors, related_name="videos", verbose_name="بازیگران"
    )
    ...
    time = models.CharField(
        max_length=30, verbose_name="مدت زمان", null=True, blank=True
    )
    created_at = models.DateTimeField("تاریخ آپلود ویدئو", auto_now_add=True)
    updated_at = models.DateTimeField(
        "تاریخ به روز رسانی ویدئو", auto_now=True, null=True
    )
    ...
    slug = models.SlugField(
        "اسلاگ", unique=True, null=True, blank=True, allow_unicode=True
    )
    ...
    def show_image(self):
        if self.image:
            return format_html(
                f'<img src="{self.image.url}" width="60px" height="50px">'
            )
        else:
...
class Like(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="likes", verbose_name="کاربر"
    )
    video = models.ForeignKey(
        Video, on_delete=models.CASCADE, related_name="likes", verbose_name="ویدئو"
    )
...
class Serial(models.Model):
    ...
    name = models.CharField(
        max_length=120, null=True, blank=True, verbose_name="نام سریال"
    )
...
class Season(models.Model):
    ...
    subject = models.CharField(
        max_length=10, verbose_name="موضوع فصل", null=True, blank=True
    )

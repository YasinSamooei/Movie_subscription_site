...
class ArticleCreate(
    BlogAuthorAccessMixin, AuthorsAccessMixin, FormValidMixin, FieldsMixin, CreateView
):
    model = Blog
    fields = [
        "author",
...
class ArticleDelete(
    BlogAuthorAccessMixin, AuthorsAccessMixin, AuthorAccessMixin, DeleteView
):
    model = Blog
    success_url = reverse_lazy("panel:article-list")
...
class CreateVideoView(
    VideoPublisherAccessMixin, AuthorsAccessMixin, VideoFormValidMixin, CreateView
):
    model = Video
    fields = [
        "title",
...
class VideoUpdateView(
    VideoPublisherAccessMixin, AuthorsAccessMixin, CreatorAccessMixin, UpdateView
):
    model = Video
    fields = [
        "title",
...
class VideoDeleteView(
    VideoPublisherAccessMixin, AuthorsAccessMixin, CreatorAccessMixin, DeleteView
):
    model = Video
    success_url = reverse_lazy("panel:video-list")

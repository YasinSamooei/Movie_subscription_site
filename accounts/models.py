...
class Subscription(models.Model):
    ...
    month = models.IntegerField(
        null=True, blank=True, verbose_name="مدت زمان(ماهانه)", default=0
    )
    day = models.IntegerField(
        null=True, blank=True, verbose_name="مدت زمان(روزانه)", default=0
    )
    week = models.IntegerField(
        null=True, blank=True, verbose_name="مدت زمان(هفتگی)", default=0
    )
